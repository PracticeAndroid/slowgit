...
import com.miuty.slowgit.ui.screen.profile.following.ProfileFollowingMvpView;
...
public class ProfileFollowersFragment extends BaseMvpListFragment<ProfileFollowersMvpView, ProfileFollowersPresenter, UserAdapter>
        implements ProfileFollowersMvpView {

    private static final String TAG = "ProfileFollowersFrag";

    private int page = 1;

    private String loginId;

    public static ProfileFollowersFragment newInstance(String loginId) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter.initLoadMore(() -> {
            ...
            presenter.getFollowers(loginId, page);
        }, mRecyclerView);
    }
    ...
    @Override
    public void showFollowersOnRecyclerView(List<User> items) {
