package com.miuty.slowgit.ui.widget.pretty;
...
import com.miuty.slowgit.ui.widget.pretty.callback.MarkDownInterceptorInterface;
import com.miuty.slowgit.ui.widget.pretty.helper.GithubHelper;
import com.miuty.slowgit.ui.widget.pretty.helper.PrettifyHelper;
import com.miuty.slowgit.util.AppHelper;
import com.miuty.slowgit.util.InputHelper;
import com.miuty.slowgit.util.Logger;
import com.miuty.slowgit.util.SchemeParser;
import com.miuty.slowgit.util.ViewHelper;
...
public class PrettifyWebView extends NestedWebView {
    ...
    private boolean hitLinkResult(WebView.HitTestResult result) {
        return result.getType() == WebView.HitTestResult.SRC_ANCHOR_TYPE || result.getType() == WebView.HitTestResult.IMAGE_TYPE ||
