package com.miuty.slowgit.ui.widget.pretty.helper;
...
import com.miuty.slowgit.util.NameParser;
import com.miuty.slowgit.util.PrefGetter;
...
public class GithubHelper {
    ...
    @NonNull
    public static String generateContent(@NonNull Context context, @NonNull String source,
    ...
    @NonNull
    private static String getParsedHtml(@NonNull String source, String owner, String repoName,
    ...
    @NonNull
    private static String mergeContent(@NonNull Context context, @NonNull String source, boolean dark) {
        return "<html>\n" +
                "\n" +
                "<head>\n" +
                "    <meta charset=\"UTF-8\">\n" +
