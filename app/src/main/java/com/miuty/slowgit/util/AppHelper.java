...
public class AppHelper {
    ...
    public static void copyToClipboard(@NonNull Context context, @NonNull String uri) {
        ...
        if (clipboard != null) {
            ...
            Toasty.success(SlowGitApplication.getInstance(), context.getString(R.string.success_copied)).show();
        }
    }
    ...
    public static String getFastHubIssueTemplate(boolean enterprise) {
        ...
        StringBuilder builder = new StringBuilder()
                ...
                .append(!isInstalledFromPlaySore(SlowGitApplication.getInstance()) ? "**APK Source: Unknown**  \n" : "")
        ...
        if (!Locale.getDefault().getLanguage().equals(new Locale("en").getLanguage())) {
            builder.append("<!--")
                    .append(SlowGitApplication.getInstance().getString(R.string.english_please))
                    .append("-->")
                    .append("\n");
        }
